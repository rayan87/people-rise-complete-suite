                ...
                new QuestionDef[]
                {
                    ...
                    new("Technical and special knowledge", "المعرفة الفنية والتخصصية", "It measures the required knowledge for the role, not the employee's personal proficiency.", "تهدف لقياس المعرفة المطلوبة للوظيفة ، وليس كفاءة موظف بعينه", 25m, true,
                        new OptionDef[]
                        {
                            ...
                            new("Working Knowledge", "عملية", "Requires practical knowledge of standard methods, tools, and processes to perform day-to-day responsibilities independently.", "تتطلب الوظيفة معرفة جيدة بالإجراءات والأدوات وأساليب العمل القياسية، مع القدرة على أداء المهام باستقلالية."),
