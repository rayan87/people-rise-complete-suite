...
namespace PeopleRise.Core.Migrations
{
    ...
    [Migration("20260918083313_IdentityAccounts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    ...
                    b.ToTable("account_role_claims", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.ToTable("account_role_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("PeopleRise.Core.Domain.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DirectoryProvider")
                        .HasColumnType("text")
                        .HasColumnName("directory_provider");
            ...
            modelBuilder.Entity("PeopleRise.Core.Domain.AccountRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PeopleRise.Core.Domain.CareerPath", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PeopleRise.Core.Domain.CareerPathStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CareerPathId", "GradeId")
                        .IsUnique();

                    b.HasIndex("CareerPathId", "StepOrder")
                        .IsUnique();

                    b.ToTable("career_path_steps");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("PeopleRise.Core.Domain.AccountRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PeopleRise.Core.Domain.Account", null)
                        .WithMany()
